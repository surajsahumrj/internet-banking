<?php
/**
 * process_transaction.php (Admin) - Page for manual deposit, withdrawal, and transfer operations.
 * * Used for teller services, system correction, and manual intervention.
 */
...
try {
    ...
    $message_type = 'error';
    error_log("Transaction Account Fetch Error: " . $e->getMessage());
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && empty($message)) {
    ...
    $description = trim($_POST['description'] ?? "Manual Admin Transaction");
...
<div class="page-title">
    ...
    <p>Perform deposits, withdrawals, and transfers on behalf of any client. All actions are logged.</p>
</div>
...
<section class="transaction-form-section" style="max-width: 800px; margin: 0 auto;">
    ...
    <div class="widget">
        ...
        <form method="POST" action="process_transaction.php" class="transaction-form">
            ...
            <div class="form-group">
                <label for="description">Description / Admin Notes</label>
                <input type="text" id="description" name="description" required 
                       value="<?php echo htmlspecialchars($_POST['description'] ?? 'Manual Admin Action'); ?>">
            </div>
